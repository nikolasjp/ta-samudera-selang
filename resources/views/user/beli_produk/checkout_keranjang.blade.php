                ...
                <div class="col-lg-9 tagline-delay">
                    ...
                    <div class="card-body">
                        <form class="form-horizontal" role="form" method="GET" action="/confirm">
                            ...
                            {{ @csrf_field() }}
                            <h5>Item {{$i++}}</h5>
                            <h5>{{$belanja->nama_barang}}</h5>
                            <h5>Rp. {{$belanja->harga}} / meter</h5>
                            <h5>Membeli : {{$_POST['quantity']}} Meter</h5>
                            <h5>Ongkos Kirim : {{$cost[0]['costs'][0]['cost'][0]['value']}}</h5>
                            <h5>Total Harga : <?php echo $belanja->harga * $_POST['quantity'] + $cost[0]['costs'][0]['cost'][0]['value'] ?></h5>
                            @endforeach
                            <h5>Pengiriman : Cabang Terdekat</h5>
                            <p style="font-weight:600; margin-top: 30px ;">Pengiriman Akan Dilakukan Paling Lambat 3 Hari Setelah Pembayaran Dikonfirmasi !</p>
                            <h5>Lakukan Pembayaran Melalui ATM BCA : 23819237 A/N Nicholass Jeffensen Purnama</h5>
                            <button style="margin-top: 12px;" type="submit" class="btn btn_franchise">Confirm</button>
                        </form>
                    </div>
                </div>
            </div>
