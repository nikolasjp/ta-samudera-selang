            ...
            <div class="row">
                ...
                <div class="col-lg-9 tagline-delay">
                    <div class="text-beli mt-5 ml-4">
                        ...
                        <div class="card-body">
                            <form class="form-horizontal" role="form" method="POST" action="/keranjang_belanja/{{$produk_hose->id_produk}}">
                                {{ @csrf_field() }}
                                <label for="">Hitungan /meter</label>
                                <div class="d-flex">
                                    <div class="pad-4">
                                ...
                                <button style="margin-top: 12px;" type="submit" class="btn btn_franchise">Masukan Keranjang <i class="fa-solid fa-cart-shopping"></i></button>
                            </form>
                        </div>
                    </div>
                </div>
