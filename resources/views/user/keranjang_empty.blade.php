...
<body style="background-color: rgba(216, 216, 216, 0.32);">
    ...
    <div class="mt-5">
        <div class="container-xl">
            <h4 class="card-title text-center m-30">Keranjang Pembelian</h4>
            <div class="card card-keranjang text-center align-items-center">
                <img width="500" src="{{ asset('/gambar/no_data.png')}}">
                <h5>Tidak ada keranjang pembelian</h5>
                <a class="btn btn-primary" href="/#produk_page">Belanja</a>
            </div>
        </div>
    </div>
    <!-- Navbar Scroll -->
