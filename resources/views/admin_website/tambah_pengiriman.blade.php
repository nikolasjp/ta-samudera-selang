        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-12 align-self-center">
                    <h3 class="text-themecolor text-center">Tambah Data Pengiriman</h3>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="page-conten" id="content">
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <form method="post" action="/add_pengiriman" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group">
                                    <label for="image" class="form-label">Upload Gambar Resi</label>
                                    <input class="form-control" type="file" name="img_resi" required>
                                </div>
