        ...
        <div class="page-wrapper">
            <div class="row page-titles">
                <div class="col-md-12 align-self-center">
                    <h3 class="text-themecolor text-center">Edit Artikel</h3>
                </div>
            </div>
            ...
            <div class="container-fluid">
                <div class="page-conten" id="content">
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            <form method="post" action="/edit_artikel/{{$produk_detail->id}}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label>Kategori Artikel</label>
                                    <select class="form-control" name="kategori_artikel" required>
                                        <option value="{{$produk_detail->kategori_artikel}}" disabled selected>{{$produk_detail->kategori_artikel}}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="header_produk" required>
                                        <option value="{{$produk_detail->header_produk}}" disabled selected>{{$produk_detail->header_produk}}</option>
                                        <option value="Hydraulic Hose">Hydraulic Hose</option>
                                        <option value="Industrial Hose">Industrial Hose</option>
                                        <option value="Pipa Nozel">PIPA NOZEL / INJECTION & NAPLE</option>
                                        <option value="Flexible Stainless">FLEXIBLE STAINLESS & INTERLOCK SS 304 - GALVANIS</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="content_produk" class="form-control" placeholder="Masukan Konten Paragraf 1" value="{{$produk_detail->content_produk}}" required>
                                        <div class="form-group">
                                            <label>Konten Paragraf 2</label>
                                            <input type="text" name="content_produk_2" class="form-control" placeholder="Masukan Konten Paragraf 2" value="{{$produk_detail->content_produk_2}}" required>
                                        </div>
